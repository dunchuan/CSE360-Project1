...
public class Companion extends ItsPane  {
   ...
   private Image image;
    ...
    private void initHappy() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(Companion.class.getClassLoader().getResource("happy.png"))); // NOI18N
    ...
    private void initThink() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(Companion.class.getClassLoader().getResource("thinking.png"))); // NOI18N
        jLabel1.setMaximumSize(getPreferredSize());
        jLabel1.setMinimumSize(getPreferredSize());
        jLabel1.setPreferredSize(getPreferredSize());
    ...
    private void initWorry() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(Companion.class.getClassLoader().getResource("worry.png"))); // NOI18N
        jLabel1.setMaximumSize(getPreferredSize());
        jLabel1.setMinimumSize(getPreferredSize());
        jLabel1.setPreferredSize(getPreferredSize());
    ...
    private void initSad() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(Companion.class.getClassLoader().getResource("sad.png"))); // NOI18N
        jLabel1.setMaximumSize(getPreferredSize());
        jLabel1.setMinimumSize(getPreferredSize());
        jLabel1.setPreferredSize(getPreferredSize());
